...
MACRO_CONFIG_INT(SvSuggestMoreRoundsLimit, sv_suggest_more_rounds_limit, 2, 0, 100, CFGFLAG_SERVER, "The limit of extra rounds votes to be allowed per map (0=no limit)")
